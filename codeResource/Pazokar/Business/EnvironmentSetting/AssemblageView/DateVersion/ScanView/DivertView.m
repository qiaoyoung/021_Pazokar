...
@interface DivertView ()
//: @property (nonatomic, strong) SGScanViewConfigure *configure;
@property (nonatomic, strong) DateVersion *configure;
...
- (instancetype)initWithNearImage:(CGRect)frame with:(DateVersion *)configure {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(soapShould)];
...
+ (instancetype)message:(CGRect)frame derivativeInstrument:(DateVersion *)configure {
    //: return [[SGScanView alloc] initWithFrame:frame configure:configure];
    return [[DivertView alloc] initWithNearImage:frame with:configure];
}
...
- (void)drawRect:(CGRect)rect {
    ...
    [self languageHolder:borderX event:borderY corner:cornerLength time:insideExcess progress:outsideExcess];
    ...
    [self optionExcess:borderX leftOrNimiety:borderY r:borderH vanguardFloat:cornerLength date:insideExcess should:outsideExcess];
    ...
    [self policy:borderX countRelation:borderY viewBy:borderW sessionFloat:cornerLength sign:insideExcess view:outsideExcess];
    ...
    [self rightFindOvermuchness:borderX dateExcess:borderY shouldTimeExcess:borderW little:borderH input:cornerLength after:insideExcess insert:outsideExcess];
}
...
- (void)languageHolder:(CGFloat)borderX event:(CGFloat)borderY corner:(CGFloat)cornerLength time:(CGFloat) insideExcess progress:(CGFloat)outsideExcess {
...
- (void)policy:(CGFloat)borderX countRelation:(CGFloat)borderY viewBy:(CGFloat)borderW sessionFloat:(CGFloat)cornerLength sign:(CGFloat) insideExcess view:(CGFloat)outsideExcess {
...
- (void)optionExcess:(CGFloat)borderX leftOrNimiety:(CGFloat)borderY r:(CGFloat)borderH vanguardFloat:(CGFloat)cornerLength date:(CGFloat) insideExcess should:(CGFloat)outsideExcess {
...
- (void)rightFindOvermuchness:(CGFloat)borderX dateExcess:(CGFloat)borderY shouldTimeExcess:(CGFloat)borderW little:(CGFloat)borderH input:(CGFloat)cornerLength after:(CGFloat) insideExcess insert:(CGFloat)outsideExcess {
...
- (void)getToTip {
    ...
    if (self.link == nil) {
        ...
        self.link = [CADisplayLink displayLinkWithTarget:[BubbleProxy with:self] selector:@selector(tableText)];
