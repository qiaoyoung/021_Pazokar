...
static CGFloat const dreamItemData = 3;

//: @implementation YasicClipAreaLayer
@implementation TitleAreaShapeLayer
...
- (void)drawInContext:(CGContextRef)ctx
{
    ...
    CGContextSetLineWidth(ctx, dreamItemData);
...
- (void)harvest:(NSInteger)cropAreaLeft current:(NSInteger)cropAreaTop dueDate:(NSInteger)cropAreaRight scaleMessage:(NSInteger)cropAreaBottom
{
    //: _cropAreaLeft = cropAreaLeft;
    _cropAreaLeft = cropAreaLeft;
    //: _cropAreaRight = cropAreaRight;
