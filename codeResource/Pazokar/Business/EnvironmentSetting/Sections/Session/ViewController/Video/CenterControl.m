...
- (void)tillFilter{
    ...
    self.thumb.center = [self day:_value];
...
- (void)setBufferProgress:(CGFloat)bufferProgress{
    ...
    bufferProgress = [self noSize:bufferProgress];
...
- (void)shadow:(UIImage *)thumbImage labelState:(UIControlState)state{
