...
@interface MagnitudeeractionClean : NSObject
...
@property (nonatomic, copy) NSArray <TheoreticalAccountPhone *> *phones;
...
@interface TheoreticalAccountPhone : NSObject
...
@interface FindPerson : NSObject

//: @property (nonatomic, copy) NSString *key;
@property (nonatomic, copy) NSString *key;

//: @property (nonatomic, copy) NSArray <CCCContactPerson *> *persons;
@property (nonatomic, copy) NSArray <MagnitudeeractionClean *> *persons;
