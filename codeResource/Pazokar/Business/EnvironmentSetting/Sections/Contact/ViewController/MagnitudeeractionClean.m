...
@implementation MagnitudeeractionClean

//: - (instancetype)initWithCNContact:(CNContact *)contact {
- (instancetype)initWithImage:(CNContact *)contact {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        if ([contact isKeyAvailable:CNContactPhoneNumbersKey])
        {
            ...
            for (CNLabeledValue *labeledValue in contact.phoneNumbers)
            {
                ...
                if ([TheoreticalAccountPhone interval:labeledValue]) {
                    //: NIMContactPhone *phoneModel = [[NIMContactPhone alloc] initWithLabeledValue:labeledValue];
                    TheoreticalAccountPhone *phoneModel = [[TheoreticalAccountPhone alloc] initWithMessage:labeledValue];
...
@implementation TheoreticalAccountPhone

//: - (instancetype)initWithLabeledValue:(CNLabeledValue *)labeledValue {
- (instancetype)initWithMessage:(CNLabeledValue *)labeledValue {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        self.phone = [NSString filter:phoneNumber];
...
+ (BOOL)interval:(CNLabeledValue *)labeledValue {
    //: CNPhoneNumber *phoneValue = labeledValue.value;
    CNPhoneNumber *phoneValue = labeledValue.value;
    //: NSString *phoneNumber = phoneValue.stringValue;
    NSString *phoneNumber = phoneValue.stringValue;
    //: NSString *userful = [NSString lj_filterSpecialString:phoneNumber];
    NSString *userful = [NSString filter:phoneNumber];
