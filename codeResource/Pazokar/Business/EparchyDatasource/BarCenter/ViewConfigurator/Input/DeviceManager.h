...
@interface CityCenterWith : NSObject
...
@interface SignalingLayout : NSObject
...
@property (nonatomic,strong) SignalingLayout *layout;
...
//: @interface BusyInputEmoticonManager : NSObject
