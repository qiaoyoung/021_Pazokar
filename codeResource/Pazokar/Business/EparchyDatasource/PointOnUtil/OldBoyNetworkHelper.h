 ...
 *
 * 如果您在使用 OldBoyNetworkHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
@interface OldBoyNetworkHelper : NSObject
...
+ (__kindof NSURLSessionTask *)bubble:(NSString *)URL
...
+ (__kindof NSURLSessionTask *)backgroundPath:(NSString *)URL
                         //: parameters:(id)parameters
                         doing:(id)parameters
                            //: success:(YLHttpRequestSuccess)success
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)must:(NSString *)URL
                         //: parameters:(id)parameters
                         title:(id)parameters
                      //: responseCache:(YLHttpRequestCache)responseCache
...
+ (__kindof NSURLSessionTask *)custom:(NSString *)URL
                                      //: parameters:(id)parameters
                                      value:(id)parameters
                                            //: name:(NSString *)name
...
+ (__kindof NSURLSessionTask *)harvestMoon:(NSString *)URL
                                       //: parameters:(id)parameters
                                       uploadShouldFailure:(id)parameters
                                             //: name:(NSString *)name
                                             tingIcon:(NSString *)name
                                             //: data:(NSData *)data
                                             stylus:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         edge:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        uploadMust:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         advancedFailure:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          success:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          tab:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)bottomFailure:(NSString *)URL
                                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)message:(NSString *)URL
                                      ...
                                      user:(YLHttpProgress)progress
                                       ...
                                       downloadWithMisplay:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
