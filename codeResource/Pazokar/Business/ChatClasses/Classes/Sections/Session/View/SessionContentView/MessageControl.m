...
// __M_A_C_R_O__
//: #import "BusySessionImageContentView.h"
...
//: @interface BusySessionImageContentView()
...
//: @implementation BusySessionImageContentView
...
//        [_imageView sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:images ];
    ...
    if (self.model.message.deliveryState == NIMMessageDeliveryStateDelivering) {
        ...
        self.progressView.of = [[NIMSDK sharedSDK].chatManager messageTransportProgress:self.model.message];
    //: }else{
    }else{
        //: self.progressView.hidden = YES;
        self.progressView.hidden = YES;
