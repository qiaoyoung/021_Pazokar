...
NSString *StringFromModeDropData(Byte *data);


//: ic_reminde_all_no
Byte mainMallPinMessage[] = {92, 17, 10, 14, 127, 195, 94, 22, 171, 98, 29, 42, 207, 184, 115, 109, 105, 124, 111, 119, 115, 120, 110, 111, 105, 107, 118, 118, 105, 120, 121, 214};

//: Need_verification
Byte show_perceiveMsg[] = {92, 17, 47, 6, 175, 117, 125, 148, 148, 147, 142, 165, 148, 161, 152, 149, 152, 146, 144, 163, 152, 158, 157, 40};

//: ic_guanliyuan
Byte show_nearlyHydraContent[] = {84, 13, 38, 4, 143, 137, 133, 141, 155, 135, 148, 146, 143, 159, 155, 135, 148, 242};

//: Allow_anyone
Byte showFinPath[] = {9, 12, 37, 9, 146, 41, 44, 132, 112, 102, 145, 145, 148, 156, 132, 134, 147, 158, 148, 147, 138, 111};

//: group_member_info_activity_team_admin
Byte mainFullSideHormoneKey[] = {55, 37, 80, 10, 208, 176, 52, 252, 81, 24, 183, 194, 191, 197, 192, 175, 189, 181, 189, 178, 181, 194, 175, 185, 190, 182, 191, 175, 177, 179, 196, 185, 198, 185, 196, 201, 175, 196, 181, 177, 189, 175, 177, 180, 189, 185, 190, 21};

//: ic_yanzheng_yes
Byte userInfoData[] = {14, 15, 76, 7, 78, 233, 128, 181, 175, 171, 197, 173, 186, 198, 180, 177, 186, 179, 171, 197, 177, 191, 47};

//: Reject_anyone
Byte userOmitKey[] = {1, 13, 92, 12, 239, 124, 250, 18, 223, 238, 225, 208, 174, 193, 198, 193, 191, 208, 187, 189, 202, 213, 203, 202, 193, 126};

//: group_info_activity_close
Byte showLaserText[] = {75, 25, 4, 5, 141, 107, 118, 115, 121, 116, 99, 109, 114, 106, 115, 99, 101, 103, 120, 109, 122, 109, 120, 125, 99, 103, 112, 115, 119, 105, 184};

//: group_info_activity_team_member
Byte show_spouseValue[] = {62, 31, 10, 4, 113, 124, 121, 127, 122, 105, 115, 120, 112, 121, 105, 107, 109, 126, 115, 128, 115, 126, 131, 105, 126, 111, 107, 119, 105, 119, 111, 119, 108, 111, 124, 71};

//: ic_all_yes
Byte dream_linePath[] = {29, 10, 88, 14, 8, 230, 50, 225, 32, 234, 127, 87, 74, 76, 193, 187, 183, 185, 196, 196, 183, 209, 189, 203, 28};

//: icon_team_creator
Byte show_optionData[] = {40, 17, 35, 6, 233, 227, 140, 134, 146, 145, 130, 151, 136, 132, 144, 130, 134, 149, 136, 132, 151, 146, 149, 41};

//: group_member_info_activity_team_creator
Byte dream_spectacularName[] = {64, 39, 30, 7, 28, 58, 119, 133, 144, 141, 147, 142, 125, 139, 131, 139, 128, 131, 144, 125, 135, 140, 132, 141, 125, 127, 129, 146, 135, 148, 135, 146, 151, 125, 146, 131, 127, 139, 125, 129, 144, 131, 127, 146, 141, 144, 166};

//: ic_all
Byte appImageHormoneStr[] = {3, 6, 21, 14, 211, 173, 28, 104, 105, 114, 191, 216, 221, 53, 126, 120, 116, 118, 129, 129, 101};

//: group_info_activity_team_notify_all
Byte m_consciousnessImageIdent[] = {11, 35, 9, 11, 208, 13, 50, 140, 26, 251, 226, 112, 123, 120, 126, 121, 104, 114, 119, 111, 120, 104, 106, 108, 125, 114, 127, 114, 125, 130, 104, 125, 110, 106, 118, 104, 119, 120, 125, 114, 111, 130, 104, 106, 117, 117, 171};

//: group_info_activity_open
Byte dream_protectText[] = {68, 24, 98, 9, 246, 176, 59, 34, 66, 201, 212, 209, 215, 210, 193, 203, 208, 200, 209, 193, 195, 197, 214, 203, 216, 203, 214, 219, 193, 209, 210, 199, 208, 199};

//: group_info_activity_team_notify_manager
Byte kGuaranteeText[] = {31, 39, 19, 9, 217, 67, 26, 122, 33, 122, 133, 130, 136, 131, 114, 124, 129, 121, 130, 114, 116, 118, 135, 124, 137, 124, 135, 140, 114, 135, 120, 116, 128, 114, 129, 130, 135, 124, 121, 140, 114, 128, 116, 129, 116, 122, 120, 133, 230};

//: group_info_activity_team_notify_mute
Byte show_absoluteStr[] = {37, 36, 81, 13, 15, 213, 150, 144, 19, 212, 219, 250, 192, 184, 195, 192, 198, 193, 176, 186, 191, 183, 192, 176, 178, 180, 197, 186, 199, 186, 197, 202, 176, 197, 182, 178, 190, 176, 191, 192, 197, 186, 183, 202, 176, 190, 198, 197, 182, 147};

//: ic_all_no
Byte showNameMessage[] = {33, 9, 18, 4, 123, 117, 113, 115, 126, 126, 113, 128, 129, 222};

//: online_state_event_manager_unknown
Byte show_beliefLeadershipName[] = {79, 34, 2, 12, 235, 96, 182, 47, 213, 232, 127, 236, 113, 112, 110, 107, 112, 103, 97, 117, 118, 99, 118, 103, 97, 103, 120, 103, 112, 118, 97, 111, 99, 112, 99, 105, 103, 116, 97, 119, 112, 109, 112, 113, 121, 112, 108};

//: icon_team_manager
Byte main_cabinUrl[] = {20, 17, 33, 12, 9, 119, 136, 58, 35, 138, 224, 14, 138, 132, 144, 143, 128, 149, 134, 130, 142, 128, 142, 130, 143, 130, 136, 134, 147, 89};

//: ic_reminde_all
Byte app_poemData[] = {51, 14, 52, 8, 120, 65, 120, 199, 157, 151, 147, 166, 153, 161, 157, 162, 152, 153, 147, 149, 160, 160, 62};

//: ic_yanzheng_no
Byte dreamSelectAheadName[] = {48, 14, 52, 6, 194, 30, 157, 151, 147, 173, 149, 162, 174, 156, 153, 162, 155, 147, 162, 163, 139};

//: ic_reminde_manager
Byte dream_winterData[] = {50, 18, 90, 13, 39, 181, 98, 223, 12, 200, 230, 248, 240, 195, 189, 185, 204, 191, 199, 195, 200, 190, 191, 185, 199, 187, 200, 187, 193, 191, 204, 48};

//: Group_Everyone
Byte dreamCanData[] = {70, 14, 18, 14, 218, 11, 238, 38, 205, 136, 35, 253, 210, 209, 89, 132, 129, 135, 130, 113, 87, 136, 119, 132, 139, 129, 128, 119, 97};

//: No_Need_verification
Byte m_letterPath[] = {82, 20, 33, 12, 36, 8, 197, 249, 109, 179, 157, 238, 111, 144, 128, 111, 134, 134, 133, 128, 151, 134, 147, 138, 135, 138, 132, 130, 149, 138, 144, 143, 94};
...
static NSString *const notiQuickUrl = @"kTeamHelperText";
//: static NSString *const kTeamHelperValue = @"kTeamHelperValue";
static NSString *const mainRecentFormat = @"kTeamHelperValue";
...
+ (NSArray<NSDictionary *> *)textIndexView {
    //: NSArray *ret = @[
    NSArray *ret = @[
                     //: @{
                     @{
...
+ (UIImage *)smart:(NIMTeamMemberType)type {
    //: UIImage *ret = nil;
    UIImage *ret = nil;
    //: switch (type) {
    switch (type) {
        ...
        case NIMTeamMemberTypeOwner:
            ...
            ret = [UIImage imageNamed:StringFromModeDropData(show_optionData)];
            //: break;
            break;
        //: case NIMTeamMemberTypeManager:
        case NIMTeamMemberTypeManager:
            //: ret = [UIImage imageNamed:@"icon_team_manager"];
            ret = [UIImage imageNamed:StringFromModeDropData(main_cabinUrl)];
            //: break;
            break;
        //: default:
        default:
...
+ (NSMutableArray *)perimeter:(NSArray <NSDictionary *> *)listDic
                         //: selectValue:(NSInteger)selectValue {
                         count:(NSInteger)selectValue {
    ...
    for (NSDictionary *dic in listDic) {
        ...
        item.title = dic[notiQuickUrl];
        //: item.img = dic[kTeamHelperImg];
        item.img = dic[notiSessionData];
        //: item.selected = (selectValue == [dic[kTeamHelperValue] integerValue]);
        item.selected = (selectValue == [dic[mainRecentFormat] integerValue]);
...
Byte * ModeDropDataToCache(Byte *data) {
    int ahead = data[0];
    int domestic = data[1];
    Byte automat = data[2];
    int happening = data[3];
    if (!ahead) return data + happening;
    for (int i = happening; i < happening + domestic; i++) {
        int value = data[i] - automat;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[happening + domestic] = 0;
    return data + happening;
}

NSString *StringFromModeDropData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)ModeDropDataToCache(data)];
}
