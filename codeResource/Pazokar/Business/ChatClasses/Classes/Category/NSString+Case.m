...
- (CGSize)messageTing:(UIFont *)font{
...
- (NSString *)maxColor {
    ...
    NSString * result = [self need:[Case pastTop].languageTable];
    //: return result;
    return result;
}

//: - (NSString *)nim_localizedWithTable:(NSString *)table {
- (NSString *)need:(NSString *)table {
    //: NSBundle * languageBundle = [MyUserKit sharedKit].languageBundle;
    NSBundle * languageBundle = [Case pastTop].languageBundle;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self tableFull:languageBundle unitOfTime:table];
}

//: - (NSString *)nim_localizedByBundle:(NSBundle *)bundle table:(NSString *)table {
- (NSString *)tableFull:(NSBundle *)bundle unitOfTime:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
