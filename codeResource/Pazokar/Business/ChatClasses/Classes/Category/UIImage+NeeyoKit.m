...
+ (UIImage *)length:(NSString *)imageName huddler:(NSString *)chartletId{
...
+ (CGSize)mediaBy:(CGSize)originSize
                              //: minSize:(CGSize)imageMinSize
                              bySize:(CGSize)imageMinSize
                              //: maxSize:(CGSize)imageMaxSiz{
                              titleSize:(CGSize)imageMaxSiz{
    //: CGSize size;
    CGSize size;
...
+ (UIImage *)recordingKit:(NSString *)imageName {
    //: if (!imageName) {
    if (!imageName) {
        //: return nil;
        return nil;
    ...
    NSString *emojiPath = [[ValuePraise sharedManager] getEmojiPath];
...
- (UIImage *)produceUpload
{
    //: CGFloat pixels = [[FFFKitDevice currentDevice] suggestImagePixels];
    CGFloat pixels = [[MarginDevice currentDevice] suggestImagePixels];
...
- (UIImage *)limitOn: (CGFloat)suggestPixels
{
...
- (UIImage *)viewSearched:(CGSize)newSize
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)bigness:(CGSize)targetSize
{
    // 裁剪两边
