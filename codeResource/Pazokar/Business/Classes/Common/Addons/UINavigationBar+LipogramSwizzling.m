...
// __CLOSE_PRINT__
//
//  UINavigationBar+LipogramSwizzling.m
//  NIM
//
...
#import "UINavigationBar+LipogramSwizzling.h"
...
@implementation UINavigationBar (LipogramSwizzling)
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        swizzling_exchangeMethod([UINavigationBar class] ,@selector(imageFile), @selector(addAcross));
    //: });
    });
}
