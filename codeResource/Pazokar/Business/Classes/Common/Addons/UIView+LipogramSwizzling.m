...
#import "UIView+LipogramSwizzling.h"
//: #import "SwizzlingDefine.h"
#import "SwizzlingDefine.h"

//: @implementation UIView (Swizzling)
@implementation UIView (LipogramSwizzling)
...
- (UIView *)notText:(CGPoint)point show:(UIEvent *)event
{
    //: UIView *view = [self swizzling_hitTest:point withEvent:event];
    UIView *view = [self notText:point show:event];
    //: if (view) {
    if (view) {
    }
    //: return view;
