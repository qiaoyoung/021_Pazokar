...
//: #333333
Byte app_popUrl[] = {35, 7, 6, 13, 219, 10, 163, 44, 206, 114, 3, 122, 129, 41, 57, 57, 57, 57, 57, 57, 63};

//: #02D8C9
Byte user_ecruVoiceSafePath[] = {60, 7, 53, 8, 44, 183, 216, 218, 88, 101, 103, 121, 109, 120, 110, 109};

//: contact_list_activity_complete
Byte show_clickPath[] = {16, 30, 11, 7, 46, 150, 7, 110, 122, 121, 127, 108, 110, 127, 106, 119, 116, 126, 127, 106, 108, 110, 127, 116, 129, 116, 127, 132, 106, 110, 122, 120, 123, 119, 112, 127, 112, 48};

//: msg
Byte noti_frameUrl[] = {29, 3, 38, 8, 80, 143, 193, 1, 147, 153, 141, 126};

//: /user/modifyPass
Byte mShowUrl[] = {28, 16, 83, 6, 57, 87, 130, 200, 198, 184, 197, 130, 192, 194, 183, 188, 185, 204, 163, 180, 198, 198, 232};

//: account
Byte noti_differentlyId[] = {27, 7, 83, 10, 59, 95, 58, 98, 93, 227, 180, 182, 182, 194, 200, 193, 199, 48};

//: renewpass
Byte kInfoValue[] = {40, 9, 19, 14, 78, 5, 209, 177, 175, 241, 103, 30, 232, 77, 133, 120, 129, 120, 138, 131, 116, 134, 134, 28};

//: activity_safe_setting_modify
Byte notiSourceMessage[] = {50, 28, 49, 6, 122, 241, 146, 148, 165, 154, 167, 154, 165, 170, 144, 164, 146, 151, 150, 144, 164, 150, 165, 165, 154, 159, 152, 144, 158, 160, 149, 154, 151, 170, 83};

//: login_bg
Byte mEnableControlText[] = {32, 8, 33, 11, 182, 158, 215, 139, 46, 69, 148, 141, 144, 136, 138, 143, 128, 131, 136, 251};

//: ic_invisible
Byte mainGreenMessage[] = {87, 12, 53, 8, 134, 75, 120, 6, 158, 152, 148, 158, 163, 171, 158, 168, 158, 151, 161, 154, 59};

//: safe_bind_phone_icon
Byte app_lineShouldVerticalValue[] = {84, 20, 81, 13, 157, 1, 63, 160, 209, 125, 82, 212, 197, 196, 178, 183, 182, 176, 179, 186, 191, 181, 176, 193, 185, 192, 191, 182, 176, 186, 180, 192, 191, 232};

//: activity_modify_new
Byte app_imageMsg[] = {11, 19, 95, 9, 118, 241, 142, 106, 132, 192, 194, 211, 200, 213, 200, 211, 216, 190, 204, 206, 195, 200, 197, 216, 190, 205, 196, 214, 177};

//: code
Byte m_infoIdent[] = {77, 4, 90, 10, 35, 165, 65, 79, 158, 90, 189, 201, 190, 191, 184};

//: modify_activity_psw_no_same
Byte m_redSourceFormat[] = {55, 27, 56, 12, 125, 210, 122, 91, 200, 50, 82, 81, 165, 167, 156, 161, 158, 177, 151, 153, 155, 172, 161, 174, 161, 172, 177, 151, 168, 171, 175, 151, 166, 167, 151, 171, 153, 165, 157, 249};

//: activity_modify_new_again
Byte mKillerKey[] = {21, 25, 89, 9, 84, 110, 78, 240, 156, 186, 188, 205, 194, 207, 194, 205, 210, 184, 198, 200, 189, 194, 191, 210, 184, 199, 190, 208, 184, 186, 192, 186, 194, 199, 117};

//: back_arrow_bl
Byte main_centerName[] = {64, 13, 65, 4, 163, 162, 164, 172, 160, 162, 179, 179, 176, 184, 160, 163, 173, 185};

//: #5D5F66
Byte mainPosseContent[] = {69, 7, 15, 4, 50, 68, 83, 68, 85, 69, 69, 255};

//: oldpass
Byte app_sizeRecentValue[] = {63, 7, 84, 7, 196, 74, 22, 195, 192, 184, 196, 181, 199, 199, 27};

//: login_error
Byte kEmphasizeName[] = {25, 11, 90, 6, 11, 242, 198, 201, 193, 195, 200, 185, 191, 204, 204, 201, 204, 56};

//: login_success
Byte main_finPath[] = {38, 13, 12, 13, 107, 143, 145, 130, 97, 20, 188, 9, 207, 120, 123, 115, 117, 122, 107, 127, 129, 111, 111, 113, 127, 127, 119};

//: ic_visible
Byte mainMyTitle[] = {15, 10, 41, 4, 146, 140, 136, 159, 146, 156, 146, 139, 149, 142, 90};

//: saft_bind_account
Byte userNearlyMessage[] = {89, 17, 58, 10, 17, 230, 79, 167, 59, 30, 173, 155, 160, 174, 153, 156, 163, 168, 158, 153, 155, 157, 157, 169, 175, 168, 174, 14};

//: register_account_activity_account
Byte kLaughMessageData[] = {30, 33, 58, 14, 104, 194, 89, 89, 110, 255, 94, 165, 54, 51, 172, 159, 161, 163, 173, 174, 159, 172, 153, 155, 157, 157, 169, 175, 168, 174, 153, 155, 157, 174, 163, 176, 163, 174, 179, 153, 155, 157, 157, 169, 175, 168, 174, 20};

//: friend_verify_avtivity_net_error
Byte k_makeMsg[] = {19, 32, 69, 12, 30, 9, 182, 68, 32, 153, 63, 155, 171, 183, 174, 170, 179, 169, 164, 187, 170, 183, 174, 171, 190, 164, 166, 187, 185, 174, 187, 174, 185, 190, 164, 179, 170, 185, 164, 170, 183, 183, 180, 183, 35};

//: type
Byte userPosseId[] = {18, 4, 10, 9, 154, 96, 152, 150, 205, 126, 131, 122, 111, 19};

//: newpass
Byte dream_textId[] = {24, 7, 46, 8, 207, 28, 242, 165, 156, 147, 165, 158, 143, 161, 161, 63};
...
- (void)viewDidLoad {
    ...
    bg.image = [UIImage imageNamed:StringFromMinData(mEnableControlText)];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromMinData(main_centerName)] forState:(UIControlStateNormal)];
    ...
    UIView *view1 = [[UIView alloc]initWithFrame:CGRectMake(20, (44.0f + [UIDevice statusOrLevel])+15, [[UIScreen mainScreen] bounds].size.width-40, 48)];
    ...
    imgname.image = [UIImage imageNamed:StringFromMinData(userNearlyMessage)];
...
//    self.textfile_1.delegate = self;
    ...
    imgname2.image = [UIImage imageNamed:StringFromMinData(app_lineShouldVerticalValue)];
...
//    self.textfile_2.delegate = self;
    ...
    [secureButton1 addTarget:self action:@selector(commentses:) forControlEvents:(UIControlEventTouchUpInside)];
    //: [secureButton1 setImage:[UIImage imageNamed:@"ic_invisible"] forState:UIControlStateNormal];
    [secureButton1 setImage:[UIImage imageNamed:StringFromMinData(mainGreenMessage)] forState:UIControlStateNormal];
    //: [secureButton1 setImage:[UIImage imageNamed:@"ic_visible"] forState:UIControlStateSelected];
    [secureButton1 setImage:[UIImage imageNamed:StringFromMinData(mainMyTitle)] forState:UIControlStateSelected];
//    secureButton1.hidden = YES;
    ...
    imgname3.image = [UIImage imageNamed:StringFromMinData(app_lineShouldVerticalValue)];
...
//    self.textfile_3.delegate = self;
    ...
    [secureButton2 addTarget:self action:@selector(heading:) forControlEvents:(UIControlEventTouchUpInside)];
    //: [secureButton2 setImage:[UIImage imageNamed:@"ic_invisible"] forState:UIControlStateNormal];
    [secureButton2 setImage:[UIImage imageNamed:StringFromMinData(mainGreenMessage)] forState:UIControlStateNormal];
    //: [secureButton2 setImage:[UIImage imageNamed:@"ic_visible"] forState:UIControlStateSelected];
    [secureButton2 setImage:[UIImage imageNamed:StringFromMinData(mainMyTitle)] forState:UIControlStateSelected];
//    secureButton2.hidden = YES;
    ...
    emptyButton.backgroundColor = [UIColor status:StringFromMinData(user_ecruVoiceSafePath)];
...
- (void)commentses:(UIButton *)sender
{
    ...
    if (sender.selected) { // 按下去了就是明文
        ...
        [sender setImage:[UIImage imageNamed:StringFromMinData(mainMyTitle)] forState:UIControlStateNormal];
    ...
    //: } else { 
        ...
        [sender setImage:[UIImage imageNamed:StringFromMinData(mainGreenMessage)] forState:UIControlStateNormal];
        //: [UIView animateWithDuration:0.25 animations:^{
        [UIView animateWithDuration:0.25 animations:^{
            //: self.textfile_2.secureTextEntry = YES;
            self.textfile_2.secureTextEntry = YES;
...
-(void)historyView
{
    ...
    [dict setObject:account forKey:StringFromMinData(noti_differentlyId)];
    //: [dict setObject:@"" forKey:@"type"];
    [dict setObject:@"" forKey:StringFromMinData(userPosseId)];
    //: [dict setObject:_textfile_1.text forKey:@"oldpass"];
    [dict setObject:_textfile_1.text forKey:StringFromMinData(app_sizeRecentValue)];
    //: [dict setObject:_textfile_2.text forKey:@"newpass"];
    [dict setObject:_textfile_2.text forKey:StringFromMinData(dream_textId)];
    //: [dict setObject:_textfile_3.text forKey:@"renewpass"];
    [dict setObject:_textfile_3.text forKey:StringFromMinData(kInfoValue)];

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/modifyPass"] params:dict isShow:YES success:^(id responseObject) {
    [TitleManageressManager size:[NSString stringWithFormat:StringFromMinData(mShowUrl)] read:dict indicator:YES spaceOf:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *msg = [resultDict newStringValueForKey:@"msg"];
        NSString *msg = [resultDict tag:StringFromMinData(noti_frameUrl)];
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict tag:StringFromMinData(m_infoIdent)];
        ...
        if (code.integerValue == 0) {
            ...
            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromMinData(main_finPath)] style:style completion:nil];
        ...
        //: }else{
            ...
            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromMinData(kEmphasizeName)] style:style completion:nil];
        }
...
Byte * MinDataToCache(Byte *data) {
    int seedVoice = data[0];
    int fainWith = data[1];
    Byte migrationSize = data[2];
    int disjunct = data[3];
    if (!seedVoice) return data + disjunct;
    for (int i = disjunct; i < disjunct + fainWith; i++) {
        int value = data[i] - migrationSize;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[disjunct + fainWith] = 0;
    return data + disjunct;
}

NSString *StringFromMinData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)MinDataToCache(data)];
}
