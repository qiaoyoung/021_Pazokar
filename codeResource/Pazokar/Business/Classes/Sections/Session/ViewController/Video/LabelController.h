...
@protocol ObserveTitle <NSObject>
...
@interface LabelController : NSObject

//: @property (nonatomic, weak) id <LYVideoPlayerDelegate> delegate;
@property (nonatomic, weak) id <ObserveTitle> delegate;
