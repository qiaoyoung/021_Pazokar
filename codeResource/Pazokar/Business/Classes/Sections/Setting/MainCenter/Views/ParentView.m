...
NSString *StringFromNearlyData(Byte *data);        


//: #5D5F66
Byte noti_titleVirusData[] = {96, 7, 26, 12, 180, 254, 17, 132, 173, 194, 245, 23, 9, 27, 42, 27, 44, 28, 28, 254};

//: Complete_operation
Byte showNameText[] = {17, 18, 19, 5, 160, 48, 92, 90, 93, 89, 82, 97, 82, 76, 92, 93, 82, 95, 78, 97, 86, 92, 91, 2};

//: Read_agree_agreement
Byte dream_backgroundTitle[] = {8, 20, 95, 7, 248, 240, 203, 243, 6, 2, 5, 0, 2, 8, 19, 6, 6, 0, 2, 8, 19, 6, 6, 14, 6, 15, 21, 86};

//: Data_Retention_Policy
Byte noti_idealId[] = {10, 21, 31, 12, 216, 62, 249, 133, 209, 106, 29, 176, 37, 66, 85, 66, 64, 51, 70, 85, 70, 79, 85, 74, 80, 79, 64, 49, 80, 77, 74, 68, 90, 129};

//: activity_register_next
Byte userMigrationPinKey[] = {67, 22, 18, 13, 204, 195, 13, 57, 233, 250, 175, 87, 71, 79, 81, 98, 87, 100, 87, 98, 103, 77, 96, 83, 85, 87, 97, 98, 83, 96, 77, 92, 83, 102, 98, 202};

//: #BCC1C8
Byte userLetterOpenValue[] = {44, 7, 24, 5, 254, 11, 42, 43, 43, 25, 43, 32, 212};

//: deactivate_account
Byte show_leadershipContent[] = {30, 18, 11, 8, 74, 255, 147, 230, 89, 90, 86, 88, 105, 94, 107, 86, 105, 90, 84, 86, 88, 88, 100, 106, 99, 105, 85};

//: login_agreement_press
Byte showToText[] = {12, 21, 67, 14, 248, 86, 186, 36, 73, 28, 182, 230, 79, 14, 41, 44, 36, 38, 43, 28, 30, 36, 47, 34, 34, 42, 34, 43, 49, 28, 45, 47, 34, 48, 48, 78};

//: #02D8C9
Byte mainShowId[] = {18, 7, 86, 12, 76, 105, 85, 52, 28, 13, 124, 48, 205, 218, 220, 238, 226, 237, 227, 55};

//: Confirm_Account_Deactivation
Byte notiManagerLabelData[] = {84, 28, 79, 7, 143, 46, 167, 244, 32, 31, 23, 26, 35, 30, 16, 242, 20, 20, 32, 38, 31, 37, 16, 245, 22, 18, 20, 37, 26, 39, 18, 37, 26, 32, 31, 33};

//: safe_arrow_next
Byte kMotorKey[] = {25, 15, 4, 11, 81, 210, 215, 19, 142, 192, 176, 111, 93, 98, 97, 91, 93, 110, 110, 107, 115, 91, 106, 97, 116, 112, 3};

//: #FF483D
Byte noti_fullFromSourceIdent[] = {63, 7, 10, 4, 25, 60, 60, 42, 46, 41, 58, 2};

//: Consequences_Deactivation
Byte dreamHonestlyLineCurrentlyName[] = {19, 25, 9, 11, 138, 167, 74, 87, 9, 16, 215, 58, 102, 101, 106, 92, 104, 108, 92, 101, 90, 92, 106, 86, 59, 92, 88, 90, 107, 96, 109, 88, 107, 96, 102, 101, 178};

//: agree_account_deactivation_terms
Byte notiHockMsg[] = {77, 32, 61, 12, 177, 236, 124, 137, 23, 69, 246, 126, 36, 42, 53, 40, 40, 34, 36, 38, 38, 50, 56, 49, 55, 34, 39, 40, 36, 38, 55, 44, 57, 36, 55, 44, 50, 49, 34, 55, 40, 53, 48, 54, 185};

//: Data_Retention_Policy_content
Byte notiSourcePath[] = {7, 29, 54, 9, 70, 68, 184, 91, 172, 14, 43, 62, 43, 41, 28, 47, 62, 47, 56, 62, 51, 57, 56, 41, 26, 57, 54, 51, 45, 67, 41, 45, 57, 56, 62, 47, 56, 62, 131};

//: Consequences_Deactivation_content
Byte kVirusName[] = {66, 33, 79, 5, 105, 244, 32, 31, 36, 22, 34, 38, 22, 31, 20, 22, 36, 16, 245, 22, 18, 20, 37, 26, 39, 18, 37, 26, 32, 31, 16, 20, 32, 31, 37, 22, 31, 37, 230};

//: #333333
Byte k_titleFormat[] = {46, 7, 55, 11, 24, 110, 189, 78, 35, 187, 30, 236, 252, 252, 252, 252, 252, 252, 177};

//: ic-delete_account
Byte app_regardingName[] = {64, 17, 94, 5, 172, 11, 5, 207, 6, 7, 14, 7, 22, 7, 1, 3, 5, 5, 17, 23, 16, 22, 202};

//: contact_tag_fragment_cancel
Byte mShowDismissUrl[] = {78, 27, 29, 9, 66, 127, 103, 225, 197, 70, 82, 81, 87, 68, 70, 87, 66, 87, 68, 74, 66, 73, 85, 68, 74, 80, 72, 81, 87, 66, 70, 68, 81, 70, 72, 79, 8};

//: login_agreement_normal
Byte mainShowValue[] = {44, 22, 44, 9, 138, 210, 62, 98, 231, 64, 67, 59, 61, 66, 51, 53, 59, 70, 57, 57, 65, 57, 66, 72, 51, 66, 67, 70, 65, 53, 64, 226};

//: Vertify_login_password
Byte user_strikeVoicePath[] = {68, 22, 86, 4, 0, 15, 28, 30, 19, 16, 35, 9, 22, 25, 17, 19, 24, 9, 26, 11, 29, 29, 33, 25, 28, 14, 246};

//: Recovery_Options_content
Byte show_messageData[] = {2, 24, 53, 4, 29, 48, 46, 58, 65, 48, 61, 68, 42, 26, 59, 63, 52, 58, 57, 62, 42, 46, 58, 57, 63, 48, 57, 63, 13};

//: Recovery_Options
Byte m_viewIdent[] = {71, 16, 83, 8, 197, 64, 14, 118, 255, 18, 16, 28, 35, 18, 31, 38, 12, 252, 29, 33, 22, 28, 27, 32, 17};
...
- (void)exceptRecord{
    ...
    if ([self.delegate respondsToSelector:@selector(menuFor)]) {
        //: [self.delegate didTouchNextButton];
        [self.delegate menuFor];
    }

}
//: - (BOOL)textFieldShouldBeginEditing:(UITextField *)textField
- (BOOL)secret:(UITextField *)textField
{
    //: return YES;
    return YES;
}
//: - (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
- (BOOL)brandName:(UITextField *)textField button:(NSRange)range monitorPressed:(NSString *)string{

    //: return YES;
    return YES;
}
//: - (void)textFieldDidEndEditing:(UITextField *)textField{
- (void)tag:(UITextField *)textField{
    //: self.titleLabel.text = textField.text;
    self.titleLabel.text = textField.text;
}
//: - (BOOL)textFieldShouldClear:(UITextField *)textField{
- (BOOL)teamClear:(UITextField *)textField{
...
- (BOOL)numerousness:(UITextField *)textField{
...
- (UIImageView *)img
{
    ...
    if(!_img){
        ...
        _img = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromNearlyData(app_regardingName)]];
    }
    //: return _img;
    return _img;
}
...
- (UIView *)nextBox
{
    ...
    if(!_nextBox){
        ...
        numView1.backgroundColor = [UIColor status:StringFromNearlyData(mainShowId)];
        ...
        numView2.backgroundColor = [UIColor status:StringFromNearlyData(userLetterOpenValue)];
        ...
        numView3.backgroundColor = [UIColor status:StringFromNearlyData(userLetterOpenValue)];
        ...
        arrow1.image = [UIImage imageNamed:StringFromNearlyData(kMotorKey)];
        ...
        arrow2.image = [UIImage imageNamed:StringFromNearlyData(kMotorKey)];
...
- (UIView *)contentBox
{
    ...
    if(!_contentBox){
        ...
        [_agreementButton setImage:[UIImage imageNamed:StringFromNearlyData(mainShowValue)] forState:UIControlStateNormal];
        //: [_agreementButton setImage:[UIImage imageNamed:@"login_agreement_press"] forState:UIControlStateSelected];
        [_agreementButton setImage:[UIImage imageNamed:StringFromNearlyData(showToText)] forState:UIControlStateSelected];
...
//        labprotocol.text = @"I have read and agree to the account deactivation terms";
        ...
        [tncString addAttribute:NSUnderlineStyleAttributeName
                          ...
                          range:(NSRange){0,[tncString length]}];
        //: [tncString addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithHexString:@"#02D8C9"] range:NSMakeRange(0,[tncString length])];
        [tncString addAttribute:NSForegroundColorAttributeName value:[UIColor status:StringFromNearlyData(mainShowId)] range:NSMakeRange(0,[tncString length])];
        //: [tncString addAttribute:NSUnderlineColorAttributeName value:[UIColor colorWithHexString:@"#02D8C9"] range:(NSRange){0,[tncString length]}];
        [tncString addAttribute:NSUnderlineColorAttributeName value:[UIColor status:StringFromNearlyData(mainShowId)] range:(NSRange){0,[tncString length]}];
...
//    [self animationClose];
    ...
    if ([self.delegate respondsToSelector:@selector(replacementButton)]) {
        //: [self.delegate didTouchProtocolButton];
        [self.delegate replacementButton];
    }
}
...
Byte * NearlyDataToCache(Byte *data) {
    int move = data[0];
    int shouldList = data[1];
    Byte greenFrom = data[2];
    int touristSize = data[3];
    if (!move) return data + touristSize;
    for (int i = touristSize; i < touristSize + shouldList; i++) {
        int value = data[i] + greenFrom;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[touristSize + shouldList] = 0;
    return data + touristSize;
}

NSString *StringFromNearlyData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)NearlyDataToCache(data)];
}
