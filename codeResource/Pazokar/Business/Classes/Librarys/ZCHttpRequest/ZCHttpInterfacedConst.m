...
NSString * actionApi(NSString *api) {
    //: NSString* resultApi;
    NSString* resultApi;
...
NSString *const notiMessageTitle = @"";
//: NSString *const iphone_md5_key = @"";
NSString *const notiKitIdent = @"";
//: NSString *const wss_msg_prefix = @"wss://open.ihccs.com/ws/myHandler/open?token=";
NSString *const kLinePath = @"wss://open.ihccs.com/ws/myHandler/open?token=";