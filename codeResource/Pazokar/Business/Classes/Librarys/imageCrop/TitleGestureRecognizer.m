...
#import "TitleGestureRecognizer.h"
//: #import <UIKit/UIGestureRecognizerSubclass.h>
#import <UIKit/UIGestureRecognizerSubclass.h>

//: @interface YasicPanGestureRecognizer()
@interface TitleGestureRecognizer()
...
@implementation TitleGestureRecognizer

//: -(instancetype)initWithTarget:(id)target action:(SEL)action inview:(UIView*)view{
-(instancetype)initWithSecretBy:(id)target pressInview:(SEL)action container:(UIView*)view{
