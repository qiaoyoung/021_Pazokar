...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [textField addTarget:self action:@selector(changing:) forControlEvents:UIControlEventEditingChanged];
...
- (void)changing:(UITextField *)textField {
