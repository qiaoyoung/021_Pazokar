...
- (void)query_strong:(BackgroundView *)cycleScrollView key:(NSInteger)index;

/** 图片滚动回调 */
//: - (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didScrollToIndex:(NSInteger)index;
- (void)statusEdge:(BackgroundView *)cycleScrollView showLanguage:(NSInteger)index;
...
+ (instancetype)add:(CGRect)frame cell:(NSArray *)imageURLStringsGroup;
