...
#import "UIView+Read.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: NSString * const kViewUserInfo = @"kAlertViewUserInfo";
NSString * const dreamVersionId = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (Read)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(dreamVersionId), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(dreamVersionId));
}
...
- (void)sessionPlace:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)allow {
    ...
    return (UIViewController *)[self last:self];
}
...
- (UIView *)reply:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView reply:superViewClass];
    }
